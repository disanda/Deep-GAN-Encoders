...
#loss AT1
        ...
        loss_medium, loss_medium_info = space_loss(imgs_medium_1.detach().clone(),imgs_medium_2.detach().clone(),lpips_model=loss_lpips)
...
#loss AT2
        ...
        loss_small, loss_small_info = space_loss(imgs_small_1.detach().clone(),imgs_small_2.detach().clone(),lpips_model=loss_lpips)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--iterations', type=int, default=120001) # epoch = iterations//30000
    ...
    if resultPath == None:
        resultPath = "./result/StyleGAN2-Cat256-Case2-Aligned"
